...
public class Post extends AsyncTask<Void, Void, String>{
    ...
    public Post( Activity act, String url, String usr, String pwd, String xml, final String msg, AsyntaskCallBackListeners asyntaskCallBack ) {
...
//	    post.setHeader("X-Requested-With", "XMLHttpRequest");
	    ...
	    post.setHeader("X-CSRF-Token", htmp[0].getValue());
//	    post.setHeader("Accept", "application/atom+xml,application/atomsvc+xml,application/xml");
	    ...
	    if ( response.getStatusLine().getStatusCode() == IMain.STATUS_CODE_201 ){
		result = "ok";
